...
(id INT PRIMARY KEY,
 name VARCHAR(255));
--;;
INSERT INTO PUBLIC.MOVIES(ID, NAME) VALUES
(1, 'Toy Story (1995)'),
(2, 'GoldenEye (1995)'),
(3, 'Four Rooms (1995)'),
(4, 'Get Shorty (1995)'),
...
(542, 'Pocahontas (1995)'),
(543, STRINGDECODE('Mis\ufffdrables, Les (1995)')),
...
(1005, STRINGDECODE('Double vie de V\ufffdronique, La (Double Life of Veronique, The) (1991)')),
...
(1102, 'Two Much (1996)'),
(1103, 'Trust (1990)'),
(1104, STRINGDECODE('C''est arriv\ufffd pr\ufffds de chez vous (1992)')),
(1105, 'Firestorm (1998)'),
...
(1233, STRINGDECODE('N\ufffdnette et Boni (1996)')),
...
(1252, STRINGDECODE('Contempt (M\ufffdpris, Le) (1963)')),
...
(1322, STRINGDECODE('Metisse (Caf\ufffd au Lait) (1993)')),
...
(1366, STRINGDECODE('JLG/JLG - autoportrait de d\ufffdcembre (1994)')),
(1367, 'Faust (1994)'),
...
(1623, STRINGDECODE('C\ufffdr\ufffdmonie, La (1995)')),
(1624, 'Hush (1998)'),
...
(1633, STRINGDECODE('\ufffd k\ufffdldum klaka (Cold Fever) (1994)')); 
--;;
INSERT INTO PUBLIC.MOVIES(ID, NAME) VALUES
